...
public partial struct C_V2
{
    ...
    /// </summary>
    public readonly C_V2 Normalized => new C_V2(x / Magnitude, y / Magnitude);
    #endregion
    ...
    public static C_V2 Min(C_V2 rhs, C_V2 lhs) =>
        new C_V2(
            C_Math.Lesser(rhs.x, lhs.x),
            C_Math.Lesser(rhs.y, lhs.y)
            );
    ...
    public static C_V2 Max(C_V2 lhs, C_V2 rhs) =>
        new C_V2(C_Math.Greater(lhs.x, rhs.x), C_Math.Greater(lhs.y, rhs.y));
    ...
    public static C_V2 Clamp(C_V2 a, C_V2 rangeX, C_V2 rangeY) =>
        new C_V2(
            C_Math.Clamp(a.x, rangeX.x, rangeX.y),
            C_Math.Clamp(a.y, rangeY.x, rangeY.y)
            );
    ...
    public static C_V2 Abs(C_V2 initalVec) =>
        new C_V2(C_Math.Abs(initalVec.x), C_Math.Abs(initalVec.y));
    ...
    //TODO: Create Unit Test for GetLineNormalCC. 
    /// <summary>
    /// Returns the norm of a C_Vec2D (the line perpendicular originating at the midpoint of the intial line).
    /// </summary>
    /// <param name="a"> The first point on the line. </param>
    /// <param name="b"> The second point on the line. </param>
    /// <returns></returns>
    public static C_Norm2D GetLineNormalCC(C_Point2D a, C_Point2D b) =>
        new C_Norm2D((C_Point2D)(0.5f * (C_V2)(b - a)), ((C_V2)(b - a)).Normalized);
    ...
    public static bool operator ==(C_V2 lhs, C_V2 rhs)
    {
