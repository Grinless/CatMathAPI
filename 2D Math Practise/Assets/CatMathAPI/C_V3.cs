...
public struct C_V3
{
    ...
    public static C_V3 Min(C_V3 a, C_V3 b) =>
        new(
            C_Math.Lesser(a.x, b.x),
            C_Math.Lesser(a.y, b.y),
            C_Math.Lesser(a.z, b.z)
            );
    ...
    public static C_V3 Max(C_V3 a, C_V3 b) =>
        new(
            C_Math.Greater(a.x, b.x),
            C_Math.Greater(a.y, b.y),
            C_Math.Greater(a.z, b.z)
            );
    ...
    public static C_V3 Clamp(C_V3 a, C_V2 rangeX, C_V2 rangeY, C_V2 rangeZ) =>
        new(
            C_Math.Clamp(a.x, rangeX),
            C_Math.Clamp(a.y, rangeY),
            C_Math.Clamp(a.z, rangeZ)
            );
    ...
    public static C_V3 Abs(C_V3 a) =>
        new(C_Math.Abs(a.x), C_Math.Abs(a.y), C_Math.Abs(a.z));
    #endregion
