...
public struct C_M3X3
{
    ...
    public static C_M3X3 TranslationMatrixX(float x) => TranslationMatrix(x, 0);

    public static C_M3X3 TranslationMatrixY(float y) => TranslationMatrix(0, y);

    public static C_M3X3 TranslationMatrix(Vector2 vec) => TranslationMatrix(vec.x, vec.y);
    ...
    public static C_M3X3 GetScaleMatrixX(float x) => GetScaleMatrix(x, 1);

    public static C_M3X3 GetScaleMatrixY(float y) => GetScaleMatrix(1, y);
    
    public static C_M3X3 GetScaleMatrixY(Vector2 value) => GetScaleMatrix(value.x, value.y);
